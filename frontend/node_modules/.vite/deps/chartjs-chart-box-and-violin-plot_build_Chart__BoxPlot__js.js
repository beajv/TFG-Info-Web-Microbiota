import {
  require_Chart
} from "./chunk-QEK3FC5N.js";
import {
  __commonJS
} from "./chunk-2LSFTFF7.js";

// node_modules/chartjs-chart-box-and-violin-plot/build/Chart.BoxPlot.js
var require_Chart_BoxPlot = __commonJS({
  "node_modules/chartjs-chart-box-and-violin-plot/build/Chart.BoxPlot.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require_Chart()) : typeof define === "function" && define.amd ? define(["exports", "chart.js"], factory) : (global = global || self, factory(global.ChartBoxPlot = {}, global.Chart));
    })(exports, function(exports2, Chart) {
      "use strict";
      ...
      var BoxAndWiskers = Chart.elements.BoxAndWhiskers = ArrayElementBase.extend({
        ...
        _drawBoxPlotHoriz: function _drawBoxPlotHoriz(vm, boxplot2, ctx) {
          ...
          var y0 = y - height / 2;
          if (boxplot2.q3 > boxplot2.q1) {
            ctx.fillRect(boxplot2.q1, y0, boxplot2.q3 - boxplot2.q1, height);
          } else {
            ctx.fillRect(boxplot2.q3, y0, boxplot2.q1 - boxplot2.q3, height);
          }
          ctx.save();
          if (vm.medianColor) {
            ctx.strokeStyle = vm.medianColor;
          ...
          ctx.lineTo(boxplot2.median, y0 + height);
          ctx.closePath();
          ctx.stroke();
          ctx.restore();
          if (boxplot2.q3 > boxplot2.q1) {
            ctx.strokeRect(boxplot2.q1, y0, boxplot2.q3 - boxplot2.q1, height);
          } else {
            ctx.strokeRect(boxplot2.q3, y0, boxplot2.q1 - boxplot2.q3, height);
          }
          ctx.beginPath();
          ctx.moveTo(boxplot2.whiskerMin, y0);
          ctx.lineTo(boxplot2.whiskerMin, y0 + height);
          ctx.moveTo(boxplot2.whiskerMin, y);
          ctx.lineTo(boxplot2.q1, y);
          ctx.moveTo(boxplot2.whiskerMax, y0);
          ctx.lineTo(boxplot2.whiskerMax, y0 + height);
      ...
      exports2.ArrayLinearScale = ArrayLinearScale;
      exports2.ArrayLogarithmicScale = ArrayLogarithmicScale;
      exports2.BoxAndWhiskers = BoxAndWiskers;
      exports2.BoxPlot = BoxPlot;
      exports2.HorizontalBoxPlot = HorizontalBoxPlot;
      exports2.HorizontalViolin = HorizontalViolin;
      exports2.Violin = Violin;
      Object.defineProperty(exports2, "__esModule", { value: true });
    });
  }
});
export default require_Chart_BoxPlot();
//# sourceMappingURL=chartjs-chart-box-and-violin-plot_build_Chart__BoxPlot__js.js.map
